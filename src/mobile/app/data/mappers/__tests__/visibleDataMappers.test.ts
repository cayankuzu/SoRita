...
describe('visibleDataMappers', () => {
  ...
  it('normalizes multiline place title and notes when mapping server rows', () => {
    const list = mapList(
      {
        id: 'list-3',
        owner_id: 'viewer',
  ...
  it('decodes persisted multiline sentinels from list and place fields', () => {
    const list = mapList(
      {
        id: 'list-4',
        owner_id: 'viewer',
        name: 'Persisted multiline',
        description: 'Aciklama\u2028satir 2',
        emoji: null,
        cover_image_url: null,
        is_public: true,
        created_at: '2025-01-01T00:00:00.000Z',
