...
describe('useUserMutations extra coverage', () => {
  ...
  it('invalidates visible data and related social caches for update/block/unblock and clears cache on delete', async () => {
    ...
    expect(reportUserMock).toHaveBeenCalledWith('viewer', 'target', 'spam', undefined);
  });
});
