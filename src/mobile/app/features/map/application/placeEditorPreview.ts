...
import { trimPreservingLineBreaks } from '@/mobile/app/shared/validation/contentLimits';
...
export function buildPreviewPlace({
  ...
  return {
    ...
    notes: trimPreservingLineBreaks(notes) || undefined,
    rating,
...
export function buildPlaceSavePayload(snapshot: PlaceEditorSnapshot): Omit<Place, 'id' | 'addedAt'> {
  ...
  return {
    ...
    title: trimPreservingLineBreaks(snapshot.title) || undefined,
