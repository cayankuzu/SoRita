  ...
  return (
    <View style={styles.stepContent}>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionHelper}>Yarim yildiz icin bir kez, tam yildiz icin iki kez dokun</Text>
        <RatingSelector value={rating} onChange={onRatingChange} />
      </View>

      <View style={styles.section}>
        <Text style={styles.sectionTitle}>{tr.placeEditor.category}</Text>
        <Text style={styles.sectionHelper}>Birden fazla kategori sec</Text>
        <OptionRail
        ...
        />
        <Text style={styles.selectionMeta}>{selectedCategories.length} kategori secildi</Text>
      </View>
    </View>
  );
}
