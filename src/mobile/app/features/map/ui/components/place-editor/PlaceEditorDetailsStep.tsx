    ...
    <View style={styles.stepContent}>
      ...
      <View style={styles.section}>
        ...
        {dietarySelections.length > 0 ? (
          <Text style={styles.selectionMeta}>{dietarySelections.length} secenek secildi</Text>
        ) : null}
      </View>
      ...
      <View style={styles.section}>
        ...
        <Text style={styles.sectionHelper}>Birden fazla zaman sec</Text>
        <OptionRail options={PLACE_BEST_TIME_OPTIONS} selectedValues={bestTimes} onToggle={onToggleBestTime} />
        {bestTimes.length > 0 ? <Text style={styles.selectionMeta}>{bestTimes.length} zaman secildi</Text> : null}
      </View>
    </View>
  );
}
