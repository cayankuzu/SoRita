...
export const HOME_FEED_INITIAL_RENDER_COUNT = 2;
export const HOME_FEED_RENDER_BATCH_SIZE = 3;
export const HOME_FEED_WINDOW_SIZE = 4;
export const MEDIA_PREFETCH_AHEAD_CARD_COUNT = 2;
export const MEDIA_PREFETCH_VIEWABILITY_DELAY_MS = 120;
