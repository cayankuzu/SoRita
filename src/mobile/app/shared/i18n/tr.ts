export const tr = {
  ...
  cards: {
    ...
    map: 'Harita',
    menuLinkLabel: 'Menü URL',
    menuLinkExpanded: 'Menü bağlantısı genişletildi',
    menuLinkExpandHint: 'Tam bağlantıyı gösterir',
    menuLinkHoldHint: 'Açmak için 0.5 sn basılı tutun',
    menuLinkOpenHint: 'Bağlantıyı açmak için tekrar dokun',
