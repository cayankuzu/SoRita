...
const showAll = !args.has('--filtered') || args.has('--all');
...
const textMatchers = [
  /\[SoRita\]/i,
  /host\.exp\.exponent/i,
  /com\.cayan\.sorita\.socialmap/i,
  /com\.sorita\.app/i,
  /google maps android api/i,
  /authorization failure/i,
  /error requesting api token/i,
  /supabase/i,
  /hermes/i,
  /unhandled/i,
  /typeerror/i,
